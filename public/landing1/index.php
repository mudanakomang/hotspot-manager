...
<head>
    ...
    <title>Rama Residence Padma Hotspot Service | Home</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="http://10.10.1.3/hotspot-manager/public/landing/index.php">Home</a>
                        </li>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-12">
                    <div class="alert alert-success">
                        ...
                        click <a href="http://ramaresidencepadma.com/">here</a> to continue browsing.
                    </div>
                </div>
            </div><!--/.row-->
        </div><!--/.container-->
