            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="http://192.168.100.3/hotspot-manager/public/landing/index">Home</a>
                        </li>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-12">
                    <div class="alert alert-success">
                        For safety and comfort, please <a href="#inline" rel="prettyPhoto"><strong>Reset</strong></a>
                        your password or
                        click <a href="http://ramabeachhotel.com/"><strong>Here</strong></a> to continue browsing.
                    </div>
                </div>
            </div><!--/.row-->
        </div><!--/.container-->
                            ...
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <p>There are many variations of passages of Lorem Ipsum available, but the
                                        majority</p>
                                    <a class="preview" href="images/portfolio/full/item1.jpg" rel="prettyPhoto"><i
