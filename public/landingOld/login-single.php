            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control input-lg" id="inputLogin" name="username"
                           ...
                           onkeyup="document.loginform.password.value = this.value">
                </div>
            </div>
...
<?php if ($chapid) : ?>
    ...
    <script type="text/javascript">
        ...
        function doLogin() {
            ...
            document.sendin.password.value = hexMD5('<?php echo $chapid; ?>' + document.login.username.value + '<?php echo $chapchallenge; ?>');
