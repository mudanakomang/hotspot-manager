                                ...
                                <table id="example1" class="table table-bordered table-hover table-responsive">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-2" >Asigned To</th>
                                    ...
                                    @foreach($lists as $l)
                                        ...
                                        @if($l->status=='0')
                                            <tr>
                                                ...
                                                @else
                                                    <td class="info col-md-2" >None</td>
                                                    <td class="info col-md-2" ><a href="{{ url("/voucher/$l->id/activate")  }}">Activate</a> | <a href="{{ url("/voucher/$l->id/deleteuser") }}" onclick="return confirm('Are you sure you want to delete this User?');">Delete</a></td>
                                                @endif
                                            </tr>
                                        @else
                                            @if($l->useracct!=NULL)
                                                <tr>
                                                    ...
                                                    @else
                                                        <td class="danger col-md-2" >None</td>
                                    ...
                                    @foreach($expire as $ex)
                                        ...
                                        <tr>
                                            <td class=" danger col-md-2  " ><input type="checkbox" id="selectall" /></td>
                                            <td class=" danger col-md-2  " >{{ $ex->username }}</td>
                                            <td class="danger col-md-2" >-</td>
                                            <td class="danger col-md-2" >{{ $ex->type }}</td>
                                            <td class="danger col-md-2" >Expired</td>
                                            <td class="danger col-md-2" >-</td>
                                            <td class="danger col-md-2" ><a href="{{ url("/voucher/$ex->id/deleteuser") }}" onclick="return confirm('Are you sure you want to delete this User?')">Delete</a></td>
