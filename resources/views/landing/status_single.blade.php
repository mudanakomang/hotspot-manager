            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="http://10.10.1.3/hotspot-manager/public/landing/index_single.php">Home</a></li>
                        <li ><a href="{{config('app.ippublic').'login' }}">Login</a></li>
                        <li><a href="{{ config('app.ippublic').'status' }}">Status</a></li>
                        <li><a href="{{config('app.ippublic').'logout' }}">Logout</a></li>
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
                        ...
                        <div class="row vertical-center-row">
                            <div class="panel panel-default">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td>Bytes up/down</td>
                                        <td> {{ $bytesinnice }} / {{ $bytesoutnice }}</td>
                                    </tr>
                                    <?php if($sessiontimeleft) : ?>
                                    <tr>
                                        <td>Connected / left</td>
                                        <td> {{ $uptime }} / {{ $sessiontimeleft }}</td>
                                    </tr>
                                    <?php else: ?>
                                    <tr>
                                        <td>Connected</td>
