            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="{{ config('app.ipmice').'/index.html' }}">Home</a></li>
        ...
        <div class="container wow fadeInDown">
            <div class="row">
                <div class="col-sm-6 col-md-12">
                      ...
                      Welcome to MICE hotspot service. Please click <a href="http://ramaresidencepadma.com/"><strong>Here</strong></a> to continue browsing.
                    </div>
                </div>
            </div><!--/.row-->
        </div><!--/.container-->
