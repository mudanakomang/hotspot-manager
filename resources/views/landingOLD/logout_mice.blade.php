            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{ config('app.ipmice').'/login' }}">Home</a></li>
            ...
            <div class="row">
                <div class="col-sm-4 col-md-offset-4">
                    ...
                    <div class="row vertical-center-row">
                        ...
                        <div class="alert alert-success ">You have just logged out.<br>Clik <a href="{{ config('app.ipmice').'/login' }}"><strong>here</strong></a> to re-login.</div>
                    </div>
